...
export const CircularTextControls: React.FC<CircularTextControlsProps> = ({ layer, onChange }) => {
  // Presets de tamaño de fuente en puntos (pt) estándar empezando en 6 pt
  const fontPresets = [6, 7, 8, 9, 10, 11, 12, 14, 16, 18, 20, 24];
  ...
  return (
    <div className="space-y-4 text-sm">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        {/* Botones rápidos de estilo TT, tt, Subrayado, Tachado */}
        <div className="col-span-2">
          <label className="block text-xs font-semibold text-slate-300 mb-1">Formato de Texto</label>
